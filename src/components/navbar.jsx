            ...
            <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-1">
                ...
                <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="mobile-menu-language-select">
                    <ul class="flex flex-col font-medium p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-white md:flex-row md:space-x-8 md:mt-0 md:border-0 md:bg-gray-bg dark:bg-light-purple md:dark:bg-light-purple dark:border-light-purple">
                        <li>
                            <a href="/" class="block py-2 pl-3 pr-4 text-light-purple bg-white rounded md:bg-transparent md:text-light-purple md:p-0 md:dark:text-light-purple" aria-current="page">Home</a>
                        </li>
                        <li>
                            <a href="#nosotros" class="block py-2 pl-3 pr-4 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-light-purple md:p-0 dark:text-white md:dark:hover:text-light-purple dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">Nosotros</a>
                        </li>
                        <li>
                            <a href="#servicios" class="block py-2 pl-3 pr-4 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-light-purple md:p-0 dark:text-white md:dark:hover:text-light-purple dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">Servicios</a>
                        </li>
                        <li>
                            <a href="#contacto" class="block py-2 pl-3 pr-4 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-light-purple md:p-0 dark:text-white md:dark:hover:text-light-purple dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">Contacto</a>
                        </li>
                    </ul>
                </div>
            </div>
