            ...
            <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-1">
                ...
                <div class="flex items-center md:order-2">
                    ...
                    <div class="z-50 hidden my-4 text-base list-none bg-white divide-y divide-gray-100 rounded-lg shadow dark:bg-gray-700" id="language-dropdown-menu">
                        <ul class="py-2 font-medium" role="none">
                            <li>
                                <button onClick={() => i18n.changeLanguage('en')} class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-600 dark:hover:text-white" role="menuitem">
                            ...
                            <li>
                                <button onClick={() => i18n.changeLanguage('es')} class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-600 dark:hover:text-white" role="menuitem">
                                    <div class="inline-flex items-center">
                                        <svg class="h-3.5 w-3.5 rounded-full mr-2" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                                            <path fill="#FFC400" d="M0 0h512v512H0z" />
                                            <path fill="#D80027" d="M0 0h512v341.33H0z" />
                ...
                <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="mobile-menu-language-select">
                    <ul class="flex flex-col font-medium p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-white md:flex-row md:space-x-8 md:mt-0 md:border-0 md:bg-gray-bg dark:bg-light-purple md:dark:bg-light-purple dark:border-light-purple">
                        ...
                        <li>
                            <a href="#nosotros" class="block py-2 pl-3 pr-4 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-light-purple md:p-0 dark:text-white md:dark:hover:text-light-purple dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">
                                {t("navbar.aboutUs")}
                            </a>
                        </li>
                        <li>
                            <a href="#servicios" class="block py-2 pl-3 pr-4 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-light-purple md:p-0 dark:text-white md:dark:hover:text-light-purple dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">
                                {t("navbar.services")}
                            </a>
                        </li>
                        <li>
                            <a href="#contacto" class="block py-2 pl-3 pr-4 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-light-purple md:p-0 dark:text-white md:dark:hover:text-light-purple dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">
                                {t("navbar.contact")}
                            </a>
                        </li>
                    </ul>
